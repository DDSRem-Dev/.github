...
- [zakotoys/dglab-mcp](https://github.com/zakotoys/dglab-mcp) - ​Model Context Protocol (MCP) server for DG-LAB Coyote hardware, enabling AI agent control in Cursor, Claude Desktop, and OpenCode. (6 hours ago)

#### 🔭 Latest releases I've contributed to

- [jxxghp/MoviePilot-Rust](https://github.com/jxxghp/MoviePilot-Rust) ([v0.3.7](https://github.com/jxxghp/MoviePilot-Rust/releases/tag/v0.3.7), 1 hour ago) - MoviePilot Rust 加速模块
...
- [jxxghp/MoviePilot](https://github.com/jxxghp/MoviePilot) ([v3.0.8](https://github.com/jxxghp/MoviePilot/releases/tag/v3.0.8), 15 hours ago) - NAS媒体库自动化管理工具
- [jxxghp/MoviePilot-Plugins](https://github.com/jxxghp/MoviePilot-Plugins) ([FullScreenPosterWall_v2.0.0](https://github.com/jxxghp/MoviePilot-Plugins/releases/tag/FullScreenPosterWall_v2.0.0), 21 hours ago) - MoviePilot官方插件市场
...
- [chore: bump moviepilot-rust to 0.3.7](https://github.com/jxxghp/MoviePilot/pull/6777) on [jxxghp/MoviePilot](https://github.com/jxxghp/MoviePilot) (1 hour ago)
